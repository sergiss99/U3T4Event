    ...
    protected void onActivityResult(int requestCode, int resultCode,Intent data){
        ...
        if(requestCode==REQUEST && resultCode==RESULT_OK){
            ...
            if(data.getStringExtra("Month")!=null) {
                ...
                // TODO: Ex1-3 añadimos los valores pasados para luego establecerlos en el EventDataActivity
                ...
                tvCurrentData.setText(getString(R.string.tvPriority) + ": " + priority + "\n" +
                        getString(R.string.place) + ": " + place + "\n" +
                        getString(R.string.date) + ": " + day + " " + month + " " + year + "\n" +
                        getString(R.string.time) + ": " + hour + ":" + minute);
            }
        }
    }


    // TODO: Ex1-3 metodo para restablecer el posible mensaje al voltear la pantalla
    @Override
